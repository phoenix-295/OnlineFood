...
<asp:DataList ID="DataList1" runat="server" CellPadding="4" BorderColor="#CC9966" ForeColor="#333333" Width="184px" Height="222px">
    ...
    <ItemTemplate>
        <h5>
        <asp:HyperLink CssClass="HeaderBarThreshold" ID="HyperLink1" runat="server" NavigateUrl='<%# "../HomePage1.aspx?Cat_ID="+Eval("Cat_ID") %>' Text='<%# Eval("Cat_Title") %>'></asp:HyperLink></h5>
    </ItemTemplate>
