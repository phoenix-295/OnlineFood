<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="OnlineFastFood.LoginPage" %>
            ...
            <table class="nav-justified">
                <tr style="vertical-align:top">
                    <td class="auto-style1">
                        <asp:Login ID="Login1" runat="server" BackColor="#DAB273" Font-Bold="False" Font-Italic="False" Font-Size="12pt" Width="385px" ForeColor="Black" DestinationPageUrl="~/HomePage1.aspx">
                            <LayoutTemplate>
                                    ...
                                    <tr>
                                        <td>
                                            <table cellpadding="0" class="auto-style4">
                                                <tr>
                                                    <td align="center" colspan="2"><h3>Log In</h3></td>
                                                </tr>
                                                <tr>
                                                    <%--<td align="right">
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            ...
                                                            <asp:TextBox placeholder="Username" class="form-control" ID="UserName" runat="server" CssClass="auto-style2" Width="256px"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:TextBox ID="Password" runat="server" class="form-control" CssClass="auto-style2" placeholder="Password" TextMode="Password" Width="256px"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td style="text-align:center" colspan="2">
                                                        <asp:Button ForeColor="White" BackColor="#D9AE6A" class="btn btn-success btn-block" ID="LoginButton" runat="server" CommandName="Login" Text="Log In" ValidationGroup="Login1" Width="333px" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
